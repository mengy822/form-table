...
import { Ref } from 'vue';
import { tableColumnItem } from './props';
...
hasSelection: {
type: PropType<boolean | ((row: any, index: number) => boolean)>;
default: boolean;
};
hasOperation: {
type: (StringConstructor | BooleanConstructor)[];
...
hasAdd: {
type: PropType<boolean | string | ((data: dataItemType) => boolean | string)>;
default: boolean;
};
hasAddIcon: {
type: ObjectConstructor;
...
tableColumn: {
type: {
(arrayLength: number): tableColumnItem[];
(...items: tableColumnItem[]): tableColumnItem[];
new (arrayLength: number): tableColumnItem[];
new (...items: tableColumnItem[]): tableColumnItem[];
...
removeType: {
type: PropType<"warning" | "info" | "error" | "success">;
default: string;
};
removeMessageTitle: {
type: StringConstructor;
...
dataList: {
type: {
(arrayLength: number): dataItemType[];
(...items: dataItemType[]): dataItemType[];
new (arrayLength: number): dataItemType[];
new (...items: dataItemType[]): dataItemType[];
isArray(arg: any): arg is any[];
readonly prototype: any[];
from<T>(arrayLike: ArrayLike<T>): T[];
from<T, U>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: number) => U, thisArg?: any): U[];
...
rowStyle: {
type: PropType<CSSProperties | ((data: {
row: any;
rowIndex: number;
}) => CSSProperties)>;
default: () => {};
...
toggleSelection: (rows?: tableColumnItem[], ignoreSelectable?: boolean) => void;
startQuery: () => void;
query: (queryParam?: {
...
add: (...args: any[]) => void;
"update:showSearch": (...args: any[]) => void;
remove: (...args: any[]) => void;
query: (...args: any[]) => void;
update: (...args: any[]) => void;
detail: (...args: any[]) => void;
"batch-remove": (...args: any[]) => void;
import: (...args: any[]) => void;
export: (...args: any[]) => void;
dataLoadCompleted: (...args: any[]) => void;
...
"onBatch-remove"?: ((...args: any[]) => any) | undefined;
onImport?: ((...args: any[]) => any) | undefined;
onExport?: ((...args: any[]) => any) | undefined;
onDataLoadCompleted?: ((...args: any[]) => any) | undefined;
}>, {
...
baseClass: string;
maxWidth: boolean;
hasAdd: string | boolean | ((data: dataItemType) => boolean | string);
hasAddIcon: Record<string, any>;
hasBatchRemove: string | boolean | ((data: dataItemType) => boolean | string);
hasBatchRemoveIcon: Record<string, any>;
hasImport: string | boolean | ((data: dataItemType) => boolean | string);
hasImportIcon: Record<string, any>;
hasExport: string | boolean | ((data: dataItemType) => boolean | string);
hasExportIcon: Record<string, any>;
hasOperationText: boolean;
hasOperationLink: boolean;
hasDetail: string | boolean | ((data: dataItemType) => boolean | string);
hasDetailIcon: Record<string, any>;
hasDetailType: ButtonType;
hasUpdate: string | boolean | ((data: dataItemType) => boolean | string);
hasUpdateIcon: Record<string, any>;
hasUpdateType: ButtonType;
hasRemove: string | boolean | ((data: dataItemType) => boolean | string);
hasRemoveIcon: Record<string, any>;
hasRemoveType: ButtonType;
removeMessage: string;
removeType: "success" | "warning" | "info" | "error";
removeMessageTitle: string;
exportMessage: string | boolean;
exportType: "success" | "warning" | "info" | "error";
...
declare interface dataItemType {
...
export declare const MyDetail: __VLS_WithTemplateSlots_4<typeof __VLS_component_4, __VLS_TemplateResult_4["slots"]>;

export declare type MyDetailInstance = InstanceType<typeof MyDetail>;

export declare const MyDialog: __VLS_WithTemplateSlots_5<typeof __VLS_component_5, __VLS_TemplateResult_5["slots"]>;

export declare type MyDialogInstance = InstanceType<typeof MyDialog>;

export declare const MyEdit: __VLS_WithTemplateSlots_3<typeof __VLS_component_3, __VLS_TemplateResult_3["slots"]>;

export declare type MyEditInstance = InstanceType<typeof MyEdit>;

export declare const MyForm: __VLS_WithTemplateSlots_2<typeof __VLS_component_2, __VLS_TemplateResult_2["slots"]>;

export declare type MyFormInstance = InstanceType<typeof MyForm>;

export declare const MyTable: __VLS_WithTemplateSlots<typeof __VLS_component, __VLS_TemplateResult["slots"]>;

export declare type MyTableInstance = InstanceType<typeof MyTable>;
